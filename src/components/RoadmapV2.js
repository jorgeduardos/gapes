      ...
      <div className="phases-container inner">
        <div className="phase one" ref={spaceshipScrollRef}>
          <div className="container">
            <h4 className="is-aqua">
              <span>1</span> Foundation: Brand Initiatives
            </h4>
            <ol>
        ...
        <div className="phase two" ref={planetScrollRef}>
          <h4 className="is-pink">
            <span>2</span> Deliberation: Technical
          </h4>
          <ol>
        ...
        <div className="phase three">
          <h4 className="is-green">
            <span>3</span> Exploration: in progress
          </h4>
          <ol>
            <li>Community DAO</li>
